...
namespace WebApp.Controllers
{
    public class CategoriesController1 : Controller
    {
        ...
        public CategoriesController1 (ICategoryService  categoryService, IUnitOfWorkAsync unitOfWork)
        {
        ...
        public ActionResult ReadProductWithCategoryId(int categoryid, [DataSourceRequest] DataSourceRequest request)
        {
