...
namespace WebApp.Controllers
{
    public class CategoriesController : Controller
    {
		...
		public ActionResult GridRead([DataSourceRequest]DataSourceRequest request)
        {
            ...
            DataSourceResult result = _categoryService.Queryable().ToDataSourceResult(request);
            return Json(result);
        }

		[AcceptVerbs(HttpVerbs.Post)]
        public ActionResult GridCreate([DataSourceRequest] DataSourceRequest request, Category category)
        {
		...
		[AcceptVerbs(HttpVerbs.Post)]
        public ActionResult GridUpdate([DataSourceRequest] DataSourceRequest request,Category category)
        {
            if (category != null && ModelState.IsValid)
            {
        ...
        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult GridDelete([DataSourceRequest] DataSourceRequest request,Category category)
        {
            if (category != null)
            {
